...
void integer_specifier_d(flags_manager_t *manager);
void integer_specifier_hh(flags_manager_t *manager);
void integer_specifier_h(flags_manager_t *manager);
void integer_specifier_l(flags_manager_t *manager);
...
specifier const INTEGER_LENGTH_MODIFIER[L_MOD_WHOLE_NB] = {
    &integer_specifier_hh,
    &integer_specifier_h,
    &integer_specifier_l,
    &integer_specifier_ll,
    &integer_specifier_j,
    &integer_specifier_t,
    &integer_specifier_z,
    &integer_specifier_d
...
{
    (*INTEGER_LENGTH_MODIFIER[manager->length_modifier])(manager);
}
